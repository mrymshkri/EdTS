        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{route('report')}}">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                  <h1 class="h2">View Reported Issues</h1><br>
                  @foreach ($a as $rep )
                  <div class="card">
                    <h5 class="card-header">The reports
                        <a href="{{ route('hide', [$rep->id_post, $rep->id]) }}" class="btn btn-sm btn-primary" style="background-color: rgb(247, 247, 107); color:rgb(3, 3, 3); margin-left:800px;">Hide</a>
                        <a href="{{ route('delete', [$rep->id_post, $rep->id]) }}" class="btn btn-sm btn-primary" style="background-color: rgb(254, 63, 63);">Delete</a>
                    </h5>
