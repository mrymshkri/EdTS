            ...
            <form method="post">
                <div class="row">
                    ...
                    {{-- <div class="col-md-4"> --}}
                        ...
                        {{-- <div>
                            <input type="button" style="width: 100%; background-color: rgb(70, 122, 165); color:white; padding: 14px 20px; margin: 5px 0px; border: none; height:50px; border-radius: 4px; cursor: pointer;"
                            value="Edit Profile" href="{{route('edit_profile')}}" />
                        </div> --}}

                        <div>
                            <a type="button" style="text-align: center; width: 100%; background-color: rgb(70, 122, 165); color:white; padding: 14px 20px; margin: 5px 0px; border: none; height:50px; border-radius: 4px;" href="{{url('/profile/edit/'.Auth::user()->id)}}"  data-original-title="Close">
                                Edit Profile
                            </a>
                        </div>
                    ...
                    <div class="col-md-8">
                        <div class="profile-head" style="background-color: rgb(248, 244, 244); padding: 20px; margin: 5px; height:590px; width:auto; overflow:scroll;">
                                ...
                                @foreach($posts as $post)
                                    ...
                                    @elseif ($post->id_user==Auth::user()->id) --}}
