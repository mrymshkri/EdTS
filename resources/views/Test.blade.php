            ...
            <div class="card">
                <div class="row g-0">
                    ...
                    <div class="col-12 col-lg-7 col-xl-9">
                        <div class="py-2 px-4 border-bottom d-none d-lg-block" style="padding-right: 1.5rem!important; padding-left: 1.5rem!important;" id="name-chat">
                            <div class="d-flex align-items-center py-1">
                                ...
                                <div class="flex-grow-1 pl-3" >
                                    ...
                                    <div class="text-muted small"><em>Teacher at SMK Wangsa Maju </em></div>
                                </div>
                                <div>
                        ...
                        <div class="position-relative">
                            <div class="chat-messages p-4" style="display: flex; flex-direction: column; max-height: 800px; overflow-y: scroll">
                                ...
                                <div class="chat-message-left pb-4" style="margin-right: auto; display: flex; flex-shrink: 0">
                                    ...
                                    <div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                        <div class="font-weight-bold mb-1">test 123</div>
                                        Sit meis deleniti eu, pri vidit meliore docendi ut, an eum erat animal commodo.
                                    </div>
                                </div>

                                <div class="chat-message-right mb-4" style="display: flex; flex-shrink: 0; flex-direction: row-reverse; margin-left: auto">
                                    <div>
                                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png" class="rounded-circle mr-1" alt="Chris Wood" width="40" height="40">
...
$(document).ready(function(){
  $('#list_chat').click(function(){
    $('#name_chat').html("Hello <b>world!</b>");
  });
});
</script> --}}
